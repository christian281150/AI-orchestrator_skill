...
description: Set up and run a multi-agent software build for any app and any AI coding tools - spec clarity, questionnaire, skills plan, workspace, lanes, failover, reporting - once idea, spec and architecture exist.
---
